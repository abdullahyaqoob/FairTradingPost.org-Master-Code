  ...
  <div class="authMainDiv">
    <div class="authDiv">
      ...
      <div class="form">
        ...
        <p class="applyDIv">
          <span class="btnTopTxt" v-if="!loading">first time application</span>
          <button
            v-if="!loading"
            class="authBtn"
            @click="handleApply()"
          ...
          <span class="btnTopTxt" v-if="!loading">to update application</span>
          <button
            v-if="!loading"
            @click="handleLogin()"
            class="authBtn"
      ...
      /> -->
      <p style="text-align: center">
        <a target="_blank" href="https://t.me/s/fairtraderftp">
          <img
        ...
        <p style="text-align: center">
          ...
          >
            <img
              ...
              width="25px"
              alt="loading"
            /><span style="position: relative; left: 10px">loading ...</span>
          </button>
        </p>
      </div>
    </div>
  ...
  methods: {
    ...
    handleApply() {
      if (this.firstName === "") {
        ...
        this.$toasted.error("Invalid Password");
      } else if (!this.emailAddress.match(/@\w{3,20}.\w{2,6}/)) {
        this.$toasted.error("Invalid Email Address");
      } else {
        this.loading = true;
        axios
